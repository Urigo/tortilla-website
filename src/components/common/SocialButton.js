...
class ShareButton extends React.Component {
  ...
  renderFacebook() {
    return (
      <Container className={`resp-sharing-button__link ${this.props.className}`} href={`https://facebook.com/sharer/sharer.php?u=${escape(this.props.url)}`} target="_blank">
  ...
  renderTwitter() {
    return (
      <Container className={`resp-sharing-button__link ${this.props.className}`} href={`https://twitter.com/intent/tweet/?text=${escape(this.props.text)}&url=${escape(this.props.url)}`} target="_blank">
  ...
  renderPinterest() {
    return (
      <Container className={`resp-sharing-button__link ${this.props.className}`} href={`https://pinterest.com/pin/create/button/?url=${escape(this.props.url)}&media=${escape(this.props.url)}&description=${escape(this.props.text)}`} target="_blank">
